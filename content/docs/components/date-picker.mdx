...
The `DatePicker` is composed from the [Popover](/docs/components/popover) and [Calendar](/docs/components/calendar) components. See their API references for the available props.
