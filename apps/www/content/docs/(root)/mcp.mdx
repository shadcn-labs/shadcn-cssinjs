...
Run the shadcn-cssinjs MCP init command, or add the server manually:

```bash
pnpm dlx shadcn-cssinjs@latest mcp init --client claude
```
...
```json title=".cursor/mcp.json"
{
  "mcpServers": {
    "shadcn-cssinjs": {
      "command": "npx",
      "args": ["-y", "shadcn-cssinjs@latest", "mcp"]
    }
  }
}
```
