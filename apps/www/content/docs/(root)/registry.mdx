---
title: Registry
description: How this registry is structured and how to consume it with the shadcn-cssinjs CLI.
---

This project is a [shadcn registry](https://ui.shadcn.com/docs/registry) — a
collection of components distributed as source code over HTTP. The `shadcn-cssinjs` CLI reads
