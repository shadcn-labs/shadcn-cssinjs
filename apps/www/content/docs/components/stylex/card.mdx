...
<ComponentPreview base="stylex" name="card-demo">
  <CardDemo />
</ComponentPreview>
...
<ComponentPreview base="stylex" name="card-size">
  <CardSize />
</ComponentPreview>
...
<ComponentPreview base="stylex" name="card-spacing">
  <CardSpacing />
</ComponentPreview>
...
<ComponentPreview base="stylex" name="card-image">
  <CardImage />
</ComponentPreview>
...
<ComponentPreview base="stylex" name="card-rtl" direction="rtl">
  <CardRtl />
</ComponentPreview>
