...
<ComponentPreview base="stylex" name="table-demo">
  <TableDemo />
</ComponentPreview>
...
<ComponentPreview base="stylex" name="table-footer">
  <TableFooterExample />
</ComponentPreview>
...
<ComponentPreview base="stylex" name="table-actions">
  <TableActions />
</ComponentPreview>
...
<ComponentPreview base="stylex" name="table-rtl" direction="rtl">
  <TableRtl />
</ComponentPreview>
