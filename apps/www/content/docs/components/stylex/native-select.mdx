...
<ComponentPreview base="stylex" name="native-select-demo">
  <NativeSelectDemo />
</ComponentPreview>
...
<ComponentPreview base="stylex" name="native-select-disabled">
  <NativeSelectDisabled />
</ComponentPreview>

import NativeSelectInvalid from "@/examples/native-select-invalid";

### Invalid

Set `aria-invalid` to show an error state.

<ComponentPreview base="stylex" name="native-select-invalid">
  <NativeSelectInvalid />
</ComponentPreview>
...
<ComponentPreview base="stylex" name="native-select-rtl" direction="rtl">
  <NativeSelectRtl />
</ComponentPreview>
