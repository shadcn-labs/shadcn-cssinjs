...
<ComponentPreview base="stylex" name="tabs-demo">
  <TabsDemo />
</ComponentPreview>
...
<ComponentPreview base="stylex" name="tabs-line">
  <TabsLine />
</ComponentPreview>
...
<ComponentPreview base="stylex" name="tabs-vertical">
  <TabsVertical />
</ComponentPreview>
...
<ComponentPreview base="stylex" name="tabs-disabled">
  <TabsDisabled />
</ComponentPreview>

### Icons

<ComponentPreview base="stylex" name="tabs-icons">
  <TabsIcons />
</ComponentPreview>

import TabsRtl from "@/examples/tabs-rtl";

## RTL

To enable right-to-left support, see the [RTL guide](/docs/rtl).

<ComponentPreview base="stylex" name="tabs-rtl" direction="rtl">
  <TabsRtl />
</ComponentPreview>
