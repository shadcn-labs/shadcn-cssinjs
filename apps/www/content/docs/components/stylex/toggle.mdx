...
<ComponentPreview base="stylex" name="toggle-demo">
  <ToggleDemo />
</ComponentPreview>
...
<ComponentPreview base="stylex" name="toggle-outline">
  <ToggleOutline />
</ComponentPreview>

### With Text

<ComponentPreview base="stylex" name="toggle-with-text">
  <ToggleWithText />
</ComponentPreview>
...
<ComponentPreview base="stylex" name="toggle-sizes">
  <ToggleSizes />
</ComponentPreview>

### Disabled

<ComponentPreview base="stylex" name="toggle-disabled">
  <ToggleDisabled />
</ComponentPreview>
...
<ComponentPreview base="stylex" name="toggle-rtl" direction="rtl">
  <ToggleRtl />
</ComponentPreview>
