...
<ComponentPreview base="stylex" name="carousel-demo">
  <CarouselDemo />
</ComponentPreview>
...
<ComponentPreview base="stylex" name="carousel-size">
  <CarouselSize />
</ComponentPreview>
...
<ComponentPreview base="stylex" name="carousel-spacing">
  <CarouselSpacing />
</ComponentPreview>
...
<ComponentPreview base="stylex" name="carousel-orientation">
  <CarouselOrientation />
</ComponentPreview>
...
<ComponentPreview base="stylex" name="carousel-rtl" direction="rtl">
  <CarouselRtl />
</ComponentPreview>
