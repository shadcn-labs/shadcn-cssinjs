...
<ComponentPreview base="stylex" name="kbd-demo">
  <KbdDemo />
</ComponentPreview>
...
<ComponentPreview base="stylex" name="kbd-group">
  <KbdGroupExample />
</ComponentPreview>

import KbdButton from "@/examples/kbd-button";
import KbdTooltip from "@/examples/kbd-tooltip";

### Button

Use `Kbd` inside a `Button` to show a shortcut.

<ComponentPreview base="stylex" name="kbd-button">
  <KbdButton />
</ComponentPreview>
...
<ComponentPreview base="stylex" name="kbd-tooltip">
  <KbdTooltip />
</ComponentPreview>

import KbdInputGroup from "@/examples/kbd-input-group";

### Input Group

Use `Kbd` inside an `InputGroup` addon.

<ComponentPreview base="stylex" name="kbd-input-group">
  <KbdInputGroup />
</ComponentPreview>
...
<ComponentPreview base="stylex" name="kbd-rtl" direction="rtl">
  <KbdRtl />
</ComponentPreview>
