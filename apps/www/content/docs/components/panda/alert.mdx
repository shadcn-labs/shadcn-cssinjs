...
<ComponentPreview base="panda" name="alert-demo">
  <AlertDemo />
</ComponentPreview>
...
<ComponentPreview base="panda" name="alert-basic">
  <AlertBasic />
</ComponentPreview>
...
<ComponentPreview base="panda" name="alert-destructive">
  <AlertDestructive />
</ComponentPreview>
...
<ComponentPreview base="panda" name="alert-action">
  <AlertAction />
</ComponentPreview>
...
<ComponentPreview base="panda" name="alert-colors">
  <AlertColors />
</ComponentPreview>
...
<ComponentPreview base="panda" name="alert-rtl" direction="rtl">
  <AlertRtl />
</ComponentPreview>
