...
<ComponentPreview base="panda" name="command-demo" align="start">
  <CommandDemo />
</ComponentPreview>
...
<ComponentPreview base="panda" name="command-basic" align="start">
  <CommandBasic />
</ComponentPreview>

### Shortcuts

<ComponentPreview base="panda" name="command-shortcuts" align="start">
  <CommandShortcuts />
</ComponentPreview>

### Groups

<ComponentPreview base="panda" name="command-groups" align="start">
  <CommandGroups />
</ComponentPreview>

### Scrollable

<ComponentPreview base="panda" name="command-scrollable" align="start">
  <CommandScrollable />
</ComponentPreview>
...
<ComponentPreview base="panda" name="command-rtl" direction="rtl">
  <CommandRtl />
</ComponentPreview>
