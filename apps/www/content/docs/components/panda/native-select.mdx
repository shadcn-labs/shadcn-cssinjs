...
<ComponentPreview base="panda" name="native-select-demo">
  <NativeSelectDemo />
</ComponentPreview>
...
<ComponentPreview base="panda" name="native-select-disabled">
...
<ComponentPreview base="panda" name="native-select-invalid">
  <NativeSelectInvalid />
</ComponentPreview>
...
<ComponentPreview base="panda" name="native-select-rtl" direction="rtl">
  <NativeSelectRtl />
</ComponentPreview>
