...
<ComponentPreview base="panda" name="card-demo">
  <CardDemo />
</ComponentPreview>
...
<ComponentPreview base="panda" name="card-size">
  <CardSize />
</ComponentPreview>
...
<ComponentPreview base="panda" name="card-spacing">
  <CardSpacing />
</ComponentPreview>
...
<ComponentPreview base="panda" name="card-image">
  <CardImage />
</ComponentPreview>
...
<ComponentPreview base="panda" name="card-rtl" direction="rtl">
  <CardRtl />
</ComponentPreview>
