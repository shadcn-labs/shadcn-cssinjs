...
<ComponentPreview base="panda" name="breadcrumb-demo">
  <BreadcrumbDemo />
</ComponentPreview>
...
<ComponentPreview base="panda" name="breadcrumb-basic">
  <BreadcrumbBasic />
</ComponentPreview>
...
<ComponentPreview base="panda" name="breadcrumb-separator">
...
<ComponentPreview base="panda" name="breadcrumb-dropdown">
  <BreadcrumbDropdown />
</ComponentPreview>
...
<ComponentPreview base="panda" name="breadcrumb-ellipsis">
...
<ComponentPreview base="panda" name="breadcrumb-link">
  <BreadcrumbLinkDemo />
</ComponentPreview>
...
<ComponentPreview base="panda" name="breadcrumb-rtl" direction="rtl">
  <BreadcrumbRtl />
</ComponentPreview>
