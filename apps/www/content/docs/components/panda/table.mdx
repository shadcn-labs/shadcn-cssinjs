...
<ComponentPreview base="panda" name="table-demo">
  <TableDemo />
</ComponentPreview>
...
<ComponentPreview base="panda" name="table-footer">
  <TableFooterExample />
</ComponentPreview>
...
<ComponentPreview base="panda" name="table-actions">
  <TableActions />
</ComponentPreview>
...
<ComponentPreview base="panda" name="table-rtl" direction="rtl">
  <TableRtl />
</ComponentPreview>
