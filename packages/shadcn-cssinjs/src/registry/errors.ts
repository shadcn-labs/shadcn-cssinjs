...
export class ConfigMissingError extends RegistryError {
  constructor(public readonly cwd: string) {
    ...
    super(message, {
      ...
      context: { cwd },
      suggestion:
        "Run 'npx shadcn-cssinjs@latest init' to create a components.json file, or check that you're in the correct directory.",
    });
...
export class ConfigParseError extends RegistryError {
  constructor(
    ...
    super(message, {
      ...
      context: { cwd },
      suggestion:
        "Check your components.json file for syntax errors or invalid configuration. Run 'npx shadcn-cssinjs@latest init' to regenerate a valid configuration.",
    });
