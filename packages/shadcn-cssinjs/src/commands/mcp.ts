...
const SHADCN_MCP_PACKAGE = `shadcn-cssinjs@${SHADCN_MCP_VERSION}`;
...
const CLIENTS = [
  ...
  },
  {
    ...
    config: `[mcp_servers.shadcn-cssinjs]
command = "npx"
args = ["${SHADCN_MCP_PACKAGE}", "mcp"]
`,
  },
  {
    ...
    config: {
      ...
      mcp: {
        "shadcn-cssinjs": {
          type: "local",
          command: ["npx", SHADCN_MCP_PACKAGE, "mcp"],
          enabled: true,
        },
      },
    },
...
const DEPENDENCIES = [SHADCN_MCP_PACKAGE];
  ...
  .action(async (opts, command) => {
    try {
      ...
      if (options.client === "codex") {
        ...
        logger.break();
        logger.log("To configure the shadcn-cssinjs MCP server in Codex:");
        logger.break();
        logger.log(
        ...
        logger.log();
        logger.info(`[mcp_servers.shadcn-cssinjs]
command = "npx"
args = ["${SHADCN_MCP_PACKAGE}", "mcp"]`);
        logger.break();
